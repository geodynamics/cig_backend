...
class SoftwareController extends Controller {
  ...
  public function getBinaryTarballs ($package) {
    ...
    $binaries = $db->Query (
        "select
           concat('/cig/software/',software.short_name,'/',software_tarball.filename) as url,
         ...
         where 
           ...
           software_tarball.active = 'y' and
           software_tarball.source = 'n' and
           software.short_name = '".$package."'
         order by
