...
<h3> 2010 </h3>
<ul>
<xsl:apply-templates select="xml/records/record[dates/year=2010 and contains(custom3, 'RELAX')]"/>
</ul>
<h3> 2009 </h3>
<ul>
...
<h3> 2006 </h3>
<ul>
<xsl:apply-templates select="xml/records/record[dates/year=2006 and contains(custom3, 'Ellipsis3d')]"/>
</ul>
